...
![**Figure 2**](/images/posts/genomics-vs-nlp/proxy_scatter.png)
**Figure 2**: mRNA is a noisy proxy for protein. Real per-gene mRNA and protein copy numbers in mouse NIH3T3 fibroblasts (Schwanhäusser et al. 2011; $$n=4{,}230$$ genes; Spearman $$\rho=0.61$$) — fixing the mRNA leaves protein spread over two to three orders of magnitude.
