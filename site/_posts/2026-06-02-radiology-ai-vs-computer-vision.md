...
<div style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center; align-items: flex-start; margin: 1.5rem 0;">
  <figure style="flex: 1 1 260px; max-width: 360px; margin: 0; text-align: center;">
    <img src="/images/posts/2026-06-02-radiology-ai-vs-computer-vision/lung.jpg" alt="Chest radiograph showing lung opacities" style="width: 100%; height: auto; border-radius: 4px;">
  ...
  <figure style="flex: 1 1 260px; max-width: 360px; margin: 0; text-align: center;">
    <img src="/images/posts/2026-06-02-radiology-ai-vs-computer-vision/dog_in_suit.jpeg" alt="A dog wearing a business suit" style="width: 100%; height: auto; border-radius: 4px;">
    <figcaption style="font-size: 0.9em; margin-top: 0.5rem;">
